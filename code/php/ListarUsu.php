...
<body>
    <div class="div-main">
        <div class="div-right">
            <h1 class="tittle-base">Cherryadmin Listagem Usuários</h1>
            <table class="table">
        <tr>
            <td>Nome</td>
            <td>CPF</td>
        ...
        <tr>
            <?php
                while($user_data = mysqli_fetch_assoc($dados_tipo)){
                    ...
                    <td><a href="alterarUsu.php?cpf=$cpf">Alterar</a></td>
                    <td><a href="excluirUsu.php?cpf=$cpf" onclick="return confirm('Quer Realmente Excluir')">Excluir</a></td>
                    </tr>
