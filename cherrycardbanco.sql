...
CREATE TABLE IF NOT EXISTS `tbusuario` (
  ...
  `Usu_Idade` int DEFAULT NULL,
  `Usu_Avatar` varchar(50) DEFAULT NULL,
  `Usu_CEP` int DEFAULT NULL,
  `Usu_Rua` varchar(80) DEFAULT NULL,
  `Usu_Bairro` varchar(80) DEFAULT NULL,
  `Usu_numero` int DEFAULT NULL,
  `Usu_Cidade` varchar(50) DEFAULT NULL,
  `Usu_Complemento` varchar(80) DEFAULT NULL,
  `Usu_Estado` varchar(50) DEFAULT NULL,
  `Cart_Numero` bigint DEFAULT NULL,
  PRIMARY KEY (`Id_Usuario`),
  UNIQUE KEY `Usu_Email` (`Usu_Email`),
  UNIQUE KEY `Usu_CPF` (`Usu_CPF`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='tabela de usuarios do serviço Cherry Card';

-- Exportação de dados foi desmarcado.

-- Copiando estrutura para tabela cherrycard.tb_funcionario
CREATE TABLE IF NOT EXISTS `tb_funcionario` (
  ...
  `Fun_Genero` varchar(50) DEFAULT NULL,
  `Fun_DDD` varchar(3) DEFAULT NULL,
  `Fun_Telefone` varchar(12) DEFAULT NULL,
  `Fun_Idade` int DEFAULT NULL,
  `Fun_Obs` varchar(50) DEFAULT NULL,
  `Fun_Cep` int DEFAULT NULL,
  `Fun_Rua` varchar(50) DEFAULT NULL,
  `Fun_Bairro` varchar(50) DEFAULT NULL,
  `Fun_Cidade` varchar(50) DEFAULT NULL,
  `Fun_Estado` varchar(50) DEFAULT NULL,
  `Fun_Numero` int DEFAULT NULL,
  `Fun_Complemento` varchar(50) DEFAULT NULL,
  `Fun_Profissao` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`Id_Funcionario`),
  UNIQUE KEY `Fun_CPF` (`Fun_CPF`),
  UNIQUE KEY `Fun_Email` (`Fun_Email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabela para cadastrar os funcionários';
